...
export function PricingSection(){
  ...
  return (
    <section
      ...
      className="my-28 max-w-[1200px] mx-auto  "
    >
      <div className=" px-4 grid max-w-6xl gap-4 md:gap-8 ">
        <div className="flex flex-col items-center gap-6 text-center ">
          <h2 className="font-urbanist text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl">
            <Balancer>
              {/* It&apos;s{" "} */}
              <span className="bg-gradient-to-r from-pink-800 to-purple-400 bg-clip-text text-transparent">
              PRICING PLANS!
              </span>
            </Balancer>
          </h2>
